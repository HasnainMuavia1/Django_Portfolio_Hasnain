...
SECRET_KEY = 'django-insecure-p-j)5vyof_#x%x@x0f0rs1wz@+ue+slyit8hp867+r@l3$&d4q'
...
EMAIL_PORT = 587
EMAIL_USE_TLS = True
EMAIL_HOST_USER = 'hasnain.muavia2004@gmail.com'
EMAIL_HOST_PASSWORD = 'zsqi rgaj gkmb iwod  '
...
# Optional: Extend session expiry with each request
